'use strict'
var YX = function (accid, todoFunc) {
    this.accid = accid
    this.initModule()
    this.cache = new Cache()
    this.mysdk = new SDKBridge(this, this.cache, todoFunc)
...
YX.fn.openChatBox = function (account, scene) {
    ...
    var param ={
        ...
        limit:20,
        reverse:false,
        done:this.getCloudMsgsDone.bind(this)
    }
