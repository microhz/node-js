...
YX.fn.getCloudMsgsDone = function(err,data){
	console.log(err + "")
	insertCustomTeaMsg(data.msgs);
    if(!err){
        this.cache.addMsgsByReverse(data.msgs)
        var id = scene + "-" + data.to;
...
function insertCustomTeaMsg(cache) {
	...
	var defaultMsg = {
		...
		from:accid,
		fromClientType:"PC",
		fromDeviceId:"ea270db7-a459-417b-bf95-7da55b434b0f60b92582bc448dd209c27a647062ee4e",
		fromNick:"xxx",
		idClient:"523b332e1e43ac419cdbfac095fdab17",
		idServer:"2386262370",
		isHistoryable:true,
		isLocal:false,
		isOfflinable:true,
		...
		status:"success",
		target:accid,
		text:"学生你好，我是家有学霸的老师，请问有什么需要帮助的吗？",
		time:currentTime,
		to:"zrown@1922_p",
		type:"text",
		userUpdateTime:currentTime
	};
	cache.unshift(defaultMsg);
}
